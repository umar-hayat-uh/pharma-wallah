...
const INITIAL_REVIEWS: Review[] = [
  {
    ...
    rating: 4.8,
    comment:
      "Pharmawallah's virtual labs transformed my understanding of Pharmaceutical Chemistry.",
  ...
  },
  {
    ...
    rating: 5.0,
    comment:
      "As someone who struggled with Pharmacognosy, the visual drug encyclopedia and MCQ bank have been lifesavers.",
  ...
  },
  {
    ...
    rating: 4.7,
    comment:
      "The HEC-aligned curriculum coverage is exceptional. I no longer need multiple reference books.",
  ...
  },
  {
    ...
    rating: 4.9,
    comment:
      "Clinical Pharmacy simulations helped me prepare for hospital rotations.",
...
// Background icons list for floating animation
const BG_ICONS: LucideIcon[] = [
  Pill,
  Flask,
  Beaker,
  Microscope,
...
const Testimonial = () => {
  ...
  // Generate animated background icons
  ...
  return (
    <section className="w-full py-16 md:py-20 lg:py-24 relative overflow-hidden bg-white">
      ...
      <div className="absolute inset-0 -z-10 overflow-hidden pointer-events-none">
        {bgIcons.map(({ Icon, left, top, size, rotate, delay }, idx) => (
          <motion.div
            key={idx}
            className="absolute"
            style={{ left, top }}
          ...
          >
            <Icon size={size} className="text-gray-800/30" />
          </motion.div>
        ))}
      </div>
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12">
          <div>
            ...
            <p className="mt-3 text-gray-600 max-w-xl">
              Join thousands of pharmacy students who are transforming their
              education with Pharmawallah.
            </p>
          </div>
            ...
            <div key={student.id} className="px-3">
              <div className="group relative bg-white/70 backdrop-blur-md rounded-xl p-6 hover:shadow-xl transition-all duration-300 min-h-[320px] flex flex-col border border-transparent hover:border-blue-200/50 hover:-translate-y-1">
                ...
                <div className="flex justify-between items-start mb-4 relative z-10">
                  <div
                    className={`inline-flex items-center gap-2 px-3 py-1 rounded-full bg-gradient-to-r from-blue-50 to-green-50 border border-blue-100/50 text-sm ${
                      SPECIALTY_COLORS[student.specialty] || ""
                    }`}
                  >
                    <Icon
                      icon={
                        SPECIALTY_ICONS[student.specialty] || "tabler:book"
                      }
