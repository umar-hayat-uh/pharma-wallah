      ...
      <div className="relative z-10 mx-auto max-w-screen-xl px-3 sm:px-5 lg:px-8 py-4 sm:py-6 lg:py-10 w-full">
        ...
        <div className="flex flex-col lg:flex-row gap-5 xl:gap-8 items-start w-full">
          ...
          <div className="flex-1 min-w-0 w-full">
            {/* Hero section */}
            <div
              className={`relative rounded-2xl overflow-hidden mb-4 sm:mb-5 bg-gradient-to-r ${GRAD} shadow-lg`}
            >
              ...
              <div className="relative z-10 px-4 py-5 sm:px-7 sm:py-7">
                ...
                <p className="text-white/80 text-xs sm:text-sm max-w-lg break-words">
                  {unit.description}
                </p>
                  ...
                  <div className="flex justify-center p-2 sm:p-4 bg-gray-50">
                    ...
                    >
                      <img
                        ...
                        className="max-h-72 sm:max-h-96 object-contain cursor-zoom-in mx-auto"
            ...
            <div className="mt-4 grid grid-cols-2 gap-3">
              {prevUnit ? (
                ...
                >
                  <div
                    className={`absolute top-0 left-0 right-0 h-[3px] bg-gradient-to-r ${prevUnit.gradient}`}
                  />
              ...
              {nextUnit ? (
                ...
                >
                  <div
                    className={`absolute top-0 left-0 right-0 h-[3px] bg-gradient-to-r ${nextUnit.gradient}`}
                  />
