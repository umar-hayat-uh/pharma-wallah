...
const DATA = {
  ...
  imageUrl: '/images/spotting/powder/nux-vomica.jpg',
  definition: 'Nux vomica is the dried ripe seed of Strychnos nux-vomica Linn., family Loganiaceae. It contains strychnine and brucine alkaloids and is highly toxic. The powder is greyish-white and intensely bitter — identification by microscopy is essential due to its dangerous alkaloid content.',
  generalFeatures: [
  ...
  pathophysiology: 'Strychnine is a selective competitive antagonist at glycine receptors (inhibitory neurotransmitter) in the spinal cord and brainstem. Blockade leads to uninhibited motor neuron firing — generalised muscle spasms, opisthotonos, and convulsions. Death occurs from respiratory muscle spasm and hypoxia. The minimum lethal dose is approximately 1–2 mg/kg in adults. Brucine has weaker strychnine-like activity.',
  etiology: [
  ...
  prev: { id: "turmeric", title: 'Turmeric Rhizome Powder' },
  next: { id: "digitalis", title: 'Digitalis Leaf Powder' },
};
...
export default function NuxVomicaPage() {
