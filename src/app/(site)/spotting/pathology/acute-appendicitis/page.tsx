...
const SLIDE_ID = "acute-appendicitis";

const IMAGES = ["/images/spotting/pathology/acute-appendicitis-sample.jpg", "/images/spotting/pathology/acute-appendicitis-mid.jpg", "/images/spotting/pathology/acute-appendicitis-high.jpg"] as const;
...
const DATA = {
    ...
    generalFeatures: ["Hyperplastic lymphoid follicles causing luminal obstruction", "Transmural neutrophilic infiltration of the appendiceal wall", "Neutrophil exudate spreading into the submucosa", "Inflamed and hyperaemic serosal layer", "Fibrin deposition on the peritoneal surface", "Mucosal ulceration overlying the obstructed segment"],
    sites: ["Vermiform appendix (sole site) \u2014 tip, body, or base", "Base obstruction increases risk of perforation", "May extend into pericaecal tissues causing pericaecal abscess", "Perforated appendicitis \u2192 generalised peritonitis"],
    ...
    etiology: ["Faecolith (calcified faecal mass) \u2014 most common in adults", "Lymphoid hyperplasia \u2014 most common in children (post-viral)", "Parasites (pinworms, Ascaris) \u2014 rare", "Tumour obstructing the base (carcinoid, adenocarcinoma)"],
    clinicalFeatures: ["Periumbilical pain migrating to right iliac fossa (McBurney's point)", "Anorexia, nausea, vomiting", "Low-grade fever, rebound tenderness, guarding", "Rovsing sign positive; Psoas sign positive in retrocaecal appendix", "Elevated WBC (neutrophilia), elevated CRP"],
    diagnosis: ["Clinical diagnosis supported by Alvarado score", "Ultrasound: non-compressible, blind-ending tubular structure >6 mm", "CT abdomen: gold standard \u2014 periappendiceal fat stranding, appendicolith", "Histopathology post-appendicectomy: confirms diagnosis"],
    treatment: ["Emergency appendicectomy (laparoscopic preferred)", "IV antibiotics (co-amoxiclav, metronidazole) pre- and post-op", "Interval appendicectomy after 6 weeks if appendiceal mass settles conservatively", "Perforation: peritoneal washout, drain placement"],
    prev: null,
...
// ── main page ─────────────────────────────────────────────────────────────────
export default function PathologyAcuteAppendicitisPage() {
