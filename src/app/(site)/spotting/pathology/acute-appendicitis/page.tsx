    ...
    <section className="min-h-screen bg-white relative overflow-x-hidden">
      ...
      <div className="lg:hidden sticky top-0 z-40 bg-white/95 backdrop-blur-md border-b border-gray-200 shadow-sm">
        ...
        <div className="flex border-t border-gray-100">
          ...
          {DATA.next && (
            <Link href={`/spotting/pathology/lessons/${DATA.next.id}`} className="flex-1 flex items-center justify-end gap-1.5 px-3 py-2 text-xs text-gray-600 hover:bg-rose-50 hover:text-rose-700 transition-colors border-l border-gray-100 min-w-0">
