...
const SLIDE_ID = "hodgkin-lymphoma";

const IMAGES = ["/images/spotting/pathology/hodgkin-lymphoma-sample.jpg", "/images/spotting/pathology/hodgkin-lymphoma-mid.jpg", "/images/spotting/pathology/hodgkin-lymphoma-high.jpg"] as const;
...
const DATA = {
    ...
    generalFeatures: ["Reed\u2013Sternberg cells: large binucleated / multinucleated cells \u2014 pathognomonic", "Prominent eosinophilic 'owl-eye' nucleolus in each RS cell nucleus", "Abundant pale eosinophilic cytoplasm in RS cells", "Derived from germinal-centre B-cells (CD15+, CD30+, CD45\u2212)", "Mixed inflammatory background: lymphocytes, eosinophils, plasma cells, neutrophils", "Nodular sclerosis subtype: broad collagen bands dividing lymph node into nodules"],
    sites: ["Cervical and supraclavicular lymph nodes \u2014 most common presentation", "Mediastinal lymphadenopathy: nodular sclerosis type (especially young women)", "Axillary and inguinal nodes (less common)", "Spreads in contiguous nodal fashion (unlike NHL)", "Ann Arbor staging: I\u2013IV based on nodal and extranodal involvement"],
    ...
    etiology: ["EBV association: LMP1 drives NF\u03baB activation \u2014 present in ~40% of cases", "Immunosuppression: HIV-associated Hodgkin's lymphoma", "Genetic predisposition: first-degree relatives, monozygotic twins", "Bimodal age distribution: young adults (15\u201334) and older adults (>55)"],
    clinicalFeatures: ["Painless cervical lymphadenopathy \u2014 most common presentation", "B symptoms: fever, drenching night sweats, weight loss >10% over 6 months", "Mediastinal mass: cough, dyspnoea, SVC syndrome", "Alcohol-induced lymph node pain (pathognomonic)", "Pruritus \u2014 generalised"],
    diagnosis: ["Excisional lymph node biopsy: required for subtype classification", "Histopathology + IHC: CD15+, CD30+, CD45\u2212, PAX5 dim", "CT chest/abdomen/pelvis: staging", "PET-CT: gold standard for staging and response assessment", "Bone marrow biopsy: for stage III/IV disease"],
    treatment: ["Early stage (I\u2013II): ABVD chemotherapy \u00d7 2\u20134 cycles \u00b1 radiotherapy", "Advanced stage (III\u2013IV): ABVD \u00d7 6 cycles or escalated BEACOPP", "PET-adapted therapy: de-escalation in PET-negative responders", "Relapsed/refractory: BV-based salvage + autologous stem cell transplant", "Brentuximab vedotin (anti-CD30): for relapsed HL"],
