...
const SLIDE_ID = "lipoma";

const IMAGES = ["/images/spotting/pathology/lipoma.jpg", "/images/spotting/pathology/lipoma-mid.jpg", "/images/spotting/pathology/lipoma-high.jpg"] as const;
...
const DATA = {
    ...
    generalFeatures: ["Lobules of mature adipocytes with clear (lipid-filled) cytoplasm", "Peripherally located, small, flattened nuclei \u2014 no atypia or hyperchromasia", "Delicate fibrovascular septa separating lobules", "No lipoblasts (distinguish from well-differentiated liposarcoma)", "No increased mitotic activity", "May have thick fibrous capsule or blend imperceptibly into surrounding fat"],
    sites: ["Subcutaneous tissue of trunk, shoulders, neck, and proximal extremities (most common)", "Intramuscular lipoma: deeper, less mobile, higher recurrence", "Spinal canal: epidural lipoma \u2014 compresses cord", "GI tract, breast, parotid (rare visceral sites)"],
    ...
    etiology: ["Sporadic clonal mutations \u2014 most common", "Multiple hereditary lipomatosis: autosomal dominant", "Familial multiple lipomatosis: multiple lipomas often on forearms", "MEN1: parathyroid adenoma, pituitary adenoma, and lipomas"],
    clinicalFeatures: ["Soft, mobile, painless subcutaneous lump", "Slow growing; rarely exceeds 5 cm", "Angiolipoma: painful, especially after pressure", "Large intramuscular lipoma: firmness, pseudo-malignant feel", "No systemic features; malignant transformation is exceedingly rare"],
    diagnosis: ["Clinical diagnosis: soft, mobile, painless lesion", "Ultrasound: hyperechoic or isoechoic lobulated lesion", "MRI: signal characteristics identical to normal fat \u2014 most reliable", "Excision biopsy and histopathology: definitive diagnosis"],
    treatment: ["Observation if asymptomatic and <5 cm", "Surgical excision: for cosmetic reasons, pain, or diagnostic doubt", "Liposuction: alternative for superficial lipomas", "Intramuscular lipomas: wider excision to reduce recurrence"],
