...
const SLIDE_ID = "adenocarcinoma";

const IMAGES = ["/images/spotting/pathology/adenocarcinoma-sample.png", "/images/spotting/pathology/adenocarcinoma-mid.jpg", "/images/spotting/pathology/adenocarcinoma-high.jpg"] as const;
...
const DATA = {
    ...
    generalFeatures: ["Irregular, atypical glandular structures \u2014 architectural distortion", "Abundant intraluminal mucin (mucinous variant: >50% mucin pools)", "Cancer cells infiltrating through the muscularis mucosae into submucosa", "Lymphocytic and plasma cell infiltration in the stroma", "Desmoplastic stromal reaction around tumour glands", "Metastasis to regional lymph nodes and distant organs"],
    sites: ["Colorectum: most common adenocarcinoma site in Western countries", "Stomach: intestinal type (H. pylori\u2013driven) and diffuse type (signet-ring cells)", "Lung: peripheral, arising from pneumocytes \u2014 most common lung cancer type", "Pancreas: ductal adenocarcinoma \u2014 head of pancreas (75%)", "Breast: invasive ductal carcinoma \u2014 most common breast malignancy", "Prostate, endometrium, ovary, cervix (endocervical type)"],
    ...
    etiology: ["Colonic: adenoma\u2013carcinoma sequence; HNPCC (Lynch syndrome), FAP", "Gastric: H. pylori \u2192 chronic gastritis \u2192 intestinal metaplasia \u2192 carcinoma", "Lung: smoking (though adenocarcinoma is the commonest type in non-smokers)", "Pancreatic: smoking, chronic pancreatitis, hereditary pancreatitis"],
    clinicalFeatures: ["Colorectal: change in bowel habit, rectal bleeding, weight loss, mass per rectum", "Gastric: dysphagia, weight loss, early satiety, Virchow's node", "Lung: haemoptysis, pleural effusion, clubbing", "Pancreatic: painless obstructive jaundice, Courvoisier's sign, steatorrhoea"],
    diagnosis: ["Endoscopy and biopsy: colonoscopy for colorectal, OGD for gastric", "CT/PET-CT: staging and metastasis assessment", "Histopathology: glandular architecture, invasion, desmoplasia", "Molecular profiling: KRAS, EGFR, ALK, HER2, MSI/MMR status"],
    treatment: ["Surgical resection: hemicolectomy, gastrectomy, pneumonectomy, Whipple's", "Adjuvant chemotherapy: FOLFOX (colorectal), FLOT (gastric), carboplatin-paclitaxel (lung)", "Targeted therapy: bevacizumab (anti-VEGF), cetuximab (anti-EGFR), osimertinib (EGFR-mutant lung)", "Immunotherapy: pembrolizumab for MSI-high or PD-L1 positive tumours"],
...
// ── main page ─────────────────────────────────────────────────────────────────
export default function PathologyAdenocarcinomaPage() {
