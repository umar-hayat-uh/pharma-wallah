...
const DATA = {
    ...
    generalFeatures: ["Sharply demarcated, punched-out ulcer edges (unlike malignant ulcer with heaped-up edges)", "Degeneration / necrosis of mucosal epithelium at ulcer base", "Four-zone histology: fibrinous exudate \u2192 coagulation necrosis \u2192 granulation tissue \u2192 fibrous scar", "Blood vessels at the ulcer base \u2014 erosion causes haemorrhage", "Inflammatory cells: lymphocytes, plasma cells, eosinophils in ulcer margin", "Perforation of ulcer leads to acute peritonitis"],
    sites: ["Duodenal ulcer (DU): anterior wall of first part of duodenum \u2014 most common", "Gastric ulcer (GU): lesser curvature of the antrum", "Stomal ulcer: at gastroenterostomy anastomosis", "Zollinger\u2013Ellison syndrome: multiple ulcers in atypical sites (jejunum)"],
    ...
    etiology: ["H. pylori infection: ~80% of duodenal ulcers, ~70% of gastric ulcers", "NSAIDs / aspirin: second commonest cause \u2014 especially in elderly", "Zollinger\u2013Ellison syndrome: gastrinoma causing massive acid hypersecretion", "Stress ulcers: Curling (burns), Cushing (raised ICP) ulcers", "Smoking: delays healing, increases recurrence"],
    clinicalFeatures: ["DU: epigastric pain relieved by food and antacids; nocturnal waking pain", "GU: epigastric pain precipitated or worsened by food", "Haematemesis or melaena (bleeding \u2014 most common complication)", "Sudden severe abdominal pain: perforation \u2192 peritonitis", "Pyloric obstruction: projectile vomiting, succussion splash"],
    diagnosis: ["Upper GI endoscopy (OGD): visualises ulcer; biopsy GU to exclude malignancy", "H. pylori testing: CLO test, breath test, stool antigen", "Barium meal: filling defect (rarely used now)", "Fasting serum gastrin: if ZES suspected (>1000 pg/mL diagnostic)"],
    treatment: ["H. pylori eradication: 7-day triple therapy (PPI + amoxicillin + clarithromycin)", "PPI (omeprazole 20 mg BD) for 4\u20138 weeks", "Stop NSAIDs; use selective COX-2 inhibitors with PPI if unavoidable", "Emergency: endoscopic haemostasis (adrenaline injection, clips) for bleeding", "Surgery: rarely \u2014 perforated ulcer repair (Graham patch), vagotomy"],
