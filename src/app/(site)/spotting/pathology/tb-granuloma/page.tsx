...
const SLIDE_ID = "tb-granuloma";

const IMAGES = ["/images/spotting/pathology/tb-granuloma-sample.jpg", "/images/spotting/pathology/tb-granuloma-mid.jpg", "/images/spotting/pathology/tb-granuloma-high.jpg"] as const;
...
const DATA = {
    ...
    generalFeatures: ["Central caseous (cheese-like) necrosis \u2014 amorphous eosinophilic acellular material", "Langhans giant cells: peripheral horseshoe arrangement of nuclei", "Surrounding epithelioid macrophages (transformed from monocytes)", "Rim of lymphocytic infiltration around the granuloma", "Collagen strands (fibrosis) forming the outer boundary", "ZN (Ziehl\u2013Neelsen) stain demonstrates acid-fast bacilli (AFB)"],
    sites: ["Lung (primary complex: subpleural focus + hilar lymph node)", "Lymph nodes (cervical, mediastinal, mesenteric)", "Pleura, peritoneum (military/disseminated TB)", "Gut (ileocaecal junction \u2014 most common GI site)", "Bone and joints (Pott's spine: vertebral TB)", "Kidneys, adrenal glands, CNS (tuberculomas)"],
    ...
    etiology: ["Mycobacterium tuberculosis: aerobic, acid-fast bacillus", "Mycobacterium bovis: zoonotic, from unpasteurised dairy", "Risk factors: HIV/AIDS, malnutrition, diabetes, crowded living", "Immunosuppressive therapy (corticosteroids, TNF-\u03b1 inhibitors)"],
    clinicalFeatures: ["Primary TB: usually asymptomatic; Ghon complex on CXR", "Post-primary TB: productive cough, haemoptysis, fever, night sweats, weight loss", "Pleural effusion: exudative, lymphocyte-predominant", "Extrapulmonary: lymphadenopathy, cold abscess, spinal pain (Pott's)", "Miliary TB: bilateral fine nodular shadows on CXR ('millet seeds')"],
    diagnosis: ["Sputum AFB smear and culture (Lowenstein\u2013Jensen medium \u2014 6\u20138 weeks)", "GeneXpert MTB/RIF: rapid PCR with rifampicin resistance detection", "Histopathology: caseating granuloma + ZN stain", "Tuberculin skin test (TST/Mantoux) and IGRA (QuantiFERON)", "CXR: upper lobe cavitation, hilar lymphadenopathy"],
    treatment: ["HRZE: Isoniazid + Rifampicin + Pyrazinamide + Ethambutol for 2 months", "Then HR: Isoniazid + Rifampicin for 4 months (total 6 months)", "MDR-TB: longer regimens with second-line drugs (fluoroquinolones, linezolid)", "Corticosteroids: adjunctive in TB meningitis and pericarditis"],
