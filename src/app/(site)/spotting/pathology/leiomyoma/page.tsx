...
const SLIDE_ID = "leiomyoma";

const IMAGES = ["/images/spotting/pathology/leiomyoma-sample.jpg", "/images/spotting/pathology/leiomyoma-mid.jpg", "/images/spotting/pathology/leiomyoma-high.jpg"] as const;
...
const DATA = {
    ...
    generalFeatures: ["Intersecting fascicles of spindle-shaped smooth muscle cells", "Elongated cigar-shaped (blunt-ended) nuclei \u2014 no significant atypia", "Abundant eosinophilic cytoplasm", "Variable collagen between muscle bundles", "No significant nuclear pleomorphism or hyperchromasia", "Low mitotic activity (<5 mitoses per 10 HPF)"],
    sites: ["Intramural: within myometrial wall \u2014 most common (70%)", "Subserosal: projecting from outer uterine surface \u2014 can become pedunculated", "Submucosal: bulging into endometrial cavity \u2014 causes heavy bleeding", "Cervical fibroids: rare", "Broad ligament fibroids: may compress ureter"],
    ...
    etiology: ["Hormonal: oestrogen-dependent \u2014 increases in reproductive years, regresses post-menopause", "MED12 mutation: most common somatic driver", "Genetic predisposition: Black women have 3\u20135\u00d7 higher incidence", "Obesity, nulliparity, early menarche \u2014 risk factors"],
    clinicalFeatures: ["Heavy menstrual bleeding (HMB) \u2014 leading to iron-deficiency anaemia", "Dysmenorrhoea and pelvic pain", "Urinary frequency or retention (pressure on bladder)", "Subfertility: submucosal fibroids distort endometrial cavity", "Abdominal mass in large fibroids", "Many are asymptomatic \u2014 incidental finding on ultrasound"],
    diagnosis: ["Pelvic ultrasound: hypoechoic, well-defined myometrial masses", "MRI pelvis: gold standard for mapping fibroid location pre-surgery", "Hysteroscopy: for submucosal fibroids", "Histopathology: spindle cells, cigar nuclei, low mitoses"],
    treatment: ["Conservative: GnRH analogues (leuprolide) to shrink fibroids pre-surgery", "Mifepristone or ulipristal acetate: SPRM for medical management", "Myomectomy: surgical removal preserving fertility", "Hysterectomy: definitive \u2014 for completed family or severe symptoms", "Uterine artery embolisation (UAE): minimally invasive alternative"],
