...
const IMAGES = ["/images/spotting/pathology/bph-sample.jpg", "/images/spotting/pathology/bph-mid.jpg", "/images/spotting/pathology/bph-high.jpg"] as const;
...
const DATA = {
    ...
    generalFeatures: ["Cystic glandular spaces with papillary projections into the lumen", "Double-layer epithelium: inner tall columnar secretory cells + outer cuboidal basal cells", "Corpora amylacea: laminated eosinophilic concretions in gland lumens", "Increased fibromuscular stromal component", "Secondary bladder changes: detrusor hypertrophy, diverticulum", "No invasion, no significant atypia \u2014 distinguishes from carcinoma"],
    sites: ["Transitional (periurethral) zone of the prostate \u2014 exclusive site of BPH", "Peripheral zone: site of most prostate carcinomas (not BPH)", "Enlargement compresses the prostatic urethra causing LUTS"],
    ...
    etiology: ["Ageing: prevalence increases from 8% at 31\u201340 years to 80% by age 80", "Androgens: DHT via 5\u03b1-reductase is the key driver", "Oestrogen: relative increase with ageing may sensitise stroma", "Genetic: strong familial component; multiple susceptibility loci"],
    clinicalFeatures: ["Lower urinary tract symptoms (LUTS): hesitancy, poor stream, terminal dribbling", "Storage symptoms: frequency, urgency, nocturia", "Acute urinary retention: precipitated by constipation, cold, anticholinergics", "Digital rectal exam: symmetrically enlarged, smooth, firm, non-tender prostate", "Elevated PSA (but lower density than in carcinoma)"],
    diagnosis: ["IPSS score: International Prostate Symptom Score \u2014 severity assessment", "Uroflowmetry: reduced peak flow rate (<10 mL/s)", "Post-void residual volume (PVRV): ultrasound guided", "PSA: to exclude carcinoma", "Cystoscopy / TRUS biopsy if PSA elevated or suspicious features"],
    treatment: ["Alpha-1 blockers (tamsulosin, alfuzosin): relax smooth muscle \u2014 first line", "5\u03b1-reductase inhibitors (finasteride, dutasteride): shrink gland \u2014 for large glands", "Combination therapy: alpha-blocker + 5-ARI for moderate-severe symptoms", "TURP (transurethral resection of prostate): gold-standard surgical treatment", "Laser prostatectomy (HoLEP), UroLift, Rezum: minimally invasive alternatives"],
...
// ── main page ─────────────────────────────────────────────────────────────────
export default function PathologyBphPage() {
