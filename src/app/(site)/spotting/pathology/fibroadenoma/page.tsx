...
const SLIDE_ID = "fibroadenoma";

const IMAGES = ["/images/spotting/pathology/fibroadenoma-sample.jpg", "/images/spotting/pathology/fibroadenoma-mid.jpg", "/images/spotting/pathology/fibroadenoma-high.jpg"] as const;
...
const DATA = {
    ...
    generalFeatures: ["Biphasic tumour: epithelial + fibroblastic stromal components", "Small acini and duct-like structures resembling normal breast tissue", "Fibrous stroma arranged around and between acini", "Epithelial clefts (slit-like) formed by fibrous compression \u2014 intracanalicular pattern", "Benign epithelium: regular nuclei, no atypia, no mitoses", "Well-circumscribed; usually encapsulated"],
    sites: ["Upper outer quadrant of the breast (most common quadrant for all breast lesions)", "Typically solitary; multiple in 10\u201315% (giant fibroadenoma in juveniles)", "No specific lobar distribution"],
    ...
    etiology: ["Hormonal: oestrogen-sensitive \u2014 common in reproductive years", "MED12 somatic mutations", "Black women of Caribbean or African descent: higher incidence of multiple/giant fibroadenomas", "Cyclosporine use after renal transplant \u2014 associated with giant fibroadenoma"],
    clinicalFeatures: ["Smooth, mobile, well-defined, non-tender breast lump ('breast mouse')", "Usually 1\u20133 cm; may be multiple", "No skin changes, no nipple discharge", "Triple assessment: clinical + ultrasound + FNAC/core biopsy", "Malignant transformation extremely rare (<0.1%)"],
    diagnosis: ["Ultrasound: well-defined, homogeneous, hypoechoic lesion with gentle lobulations", "FNAC / core biopsy: confirms benign biphasic histology", "Mammography: in women over 35 \u2014 calcified fibroadenoma ('popcorn' calcification)", "MRI: for multiple lesions or in high-risk patients"],
    treatment: ["Conservative management for lesions <3 cm with confirmed benign histology", "Surgical excision: for >3 cm, growing, or patient anxiety", "Vacuum-assisted biopsy excision: ultrasound-guided, no scar", "Annual review: to monitor size and exclude interval change"],
