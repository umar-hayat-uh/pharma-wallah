...
const GRAD = "from-red-500 to-rose-400";
const TITLE = "Gastritis";
const CAT = "GI Pathology";
const SLIDE_ID = "gastritis";

const IMAGES = ["/images/spotting/pathology/gastritis.jpg", "/images/spotting/pathology/gastritis-mid.jpg", "/images/spotting/pathology/gastritis-high.jpg"] as const;
const PO_URL = "https://www.pathologyoutlines.com/topic/stomachchronicgastritis.html";
const VIDEO_TITLE = "Gastritis & H. pylori Pathology Lecture";
const VIDEO_URL = "https://youtu.be/9QZR286K3w4";
...
const DATA = {
    definition: "Gastritis is inflammation of the gastric mucosa. It is classified as acute (neutrophilic infiltrate) or chronic (mononuclear infiltrate). H. pylori infection is the commonest cause of chronic active gastritis, characterised by lymphoplasmacytic infiltration of the lamina propria with superimposed neutrophilic activity.",
    generalFeatures: ["Lymphocytic infiltration of the lamina propria (chronic component)", "Neutrophil infiltration of the surface epithelium and gastric pits (active component)", "Spiral-shaped H. pylori organisms in the mucus layer overlying the epithelium", "Gastric pit (foveolar) elongation and distortion", "Intestinal metaplasia in long-standing cases \u2014 goblet cells replace gastric epithelium", "Atrophic gastritis: loss of parietal and chief cells in autoimmune type"],
    sites: ["Antrum: H. pylori\u2013associated (type B) gastritis \u2014 most common", "Body/fundus: autoimmune (type A) gastritis \u2014 anti-parietal cell antibodies", "Pangastritis: H. pylori may involve the whole stomach"],
    pathophysiology: "H. pylori colonises the gastric mucus layer and releases urease (converts urea to toxic ammonia), cytotoxin-associated gene A (CagA), and vacuolating cytotoxin (VacA), causing direct epithelial damage and triggering IL-8\u2013mediated neutrophil recruitment. Chronic infection drives lymphoid follicle formation and mucosal atrophy, increasing gastric cancer risk.",
    etiology: ["H. pylori infection \u2014 responsible for >80% of chronic gastritis", "NSAIDs / aspirin \u2014 disrupt mucosal prostaglandin synthesis", "Autoimmune: anti-parietal cell antibodies (type A) \u2014 causes megaloblastic anaemia", "Bile reflux, alcohol, stress, corticosteroids", "CMV, EBV in immunocompromised patients"],
    clinicalFeatures: ["Often asymptomatic", "Epigastric pain or discomfort, bloating, early satiety", "Nausea, heartburn", "Haematemesis or melaena in erosive gastritis", "Vitamin B12 deficiency and megaloblastic anaemia in autoimmune type"],
    diagnosis: ["Endoscopy + antral biopsy: multiple biopsies from antrum and body", "Rapid urease test (CLO test): H. pylori detection at endoscopy", "13C-urea breath test: non-invasive gold standard", "H. pylori stool antigen test (SAT)", "Histopathology: Sydney system grading of gastritis"],
    treatment: ["H. pylori eradication: 7-day triple therapy (PPI + amoxicillin + clarithromycin)", "Quadruple therapy where clarithromycin resistance is prevalent", "Autoimmune gastritis: B12 replacement (IM cyanocobalamin)", "PPI for symptomatic relief and mucosal healing", "Surveillance endoscopy for atrophic gastritis / intestinal metaplasia"],
...
// ── main page ─────────────────────────────────────────────────────────────────
export default function PathologyGastritisPage() {
