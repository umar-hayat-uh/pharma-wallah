...
const SLIDE_ID = "squamous-cell-carcinoma";

const IMAGES = ["/images/spotting/pathology/squamous-cell-carcinoma-sample.jpg", "/images/spotting/pathology/squamous-cell-carcinoma-mid.jpg", "/images/spotting/pathology/squamous-cell-carcinoma-high.jpg"] as const;
...
const DATA = {
    ...
    generalFeatures: ["Large polygonal cells with abundant eosinophilic cytoplasm", "Concentric whorls of keratinised cells forming keratin pearls", "Desmosomal connections (intercellular bridges) between adjacent cells", "Tumour cell infiltration into the underlying stroma, breaching the basement membrane", "Lymphocytic infiltrate \u00b1 plasma cells in the stroma (host response)", "Nuclear pleomorphism, hyperchromasia, and abnormal mitoses"],
    sites: ["Skin: sun-exposed areas, particularly head, neck, dorsal hands", "Oral cavity: tongue, floor of mouth (smoking + alcohol)", "Oesophagus: middle and lower third", "Lung: hilar, central, arising from bronchial epithelium (smoking)", "Cervix: squamocolumnar junction (HPV 16/18)", "Penis, vulva, anal canal"],
    ...
    etiology: ["UV radiation (skin SCC): UVB-induced p53 mutation", "Smoking and alcohol (oral, oesophageal, lung SCC)", "HPV 16 and 18: cervical, oropharyngeal, and anogenital SCC", "Chronic irritation: Marjolin's ulcer (SCC arising in chronic wounds/scars)", "Immunosuppression: organ transplant recipients \u2014 greatly elevated risk"],
    clinicalFeatures: ["Skin: indurated, keratotic nodule or ulcer with everted edges", "Oral: non-healing ulcer, leukoplakia, erythroplakia", "Lung: haemoptysis, recurrent pneumonia, Pancoast syndrome", "Cervix: post-coital bleeding, foul-smelling discharge", "Metastasis: regional lymph nodes (hard, non-tender), distant organs"],
    diagnosis: ["Biopsy and histopathology: gold standard", "Histology: keratin pearls, desmosomes, stromal invasion", "HPV testing (cervical): PCR-based genotyping", "Staging CT/PET-CT: lymph node and distant metastasis assessment"],
    treatment: ["Surgical excision with clear margins: primary treatment for localised SCC", "Mohs micrographic surgery: for facial/skin SCC \u2014 margin controlled", "Radiotherapy: for non-surgical candidates or adjuvant post-excision", "Chemoradiation (cisplatin-based): locally advanced disease", "Immune checkpoint inhibitors (pembrolizumab): metastatic/recurrent SCC"],
