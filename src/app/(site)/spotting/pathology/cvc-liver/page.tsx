...
const SLIDE_ID = "cvc-liver";

const IMAGES = ["/images/spotting/pathology/cvc-liver-sample.jpg", "/images/spotting/pathology/cvc-liver-mid.jpg", "/images/spotting/pathology/cvc-liver-high.jpg"] as const;
...
const DATA = {
    ...
    generalFeatures: ["Dilated central veins and sinusoids (centrilobular)", "Centrilobular haemorrhagic necrosis (zone 3 hepatocytes)", "Eosinophilic hepatocyte cytoplasm in zone 3", "Fatty changes in periportal (zone 1) hepatocytes", "Portal triads relatively preserved", "Chronic cases: centrilobular fibrosis \u2192 cardiac cirrhosis"],
    sites: ["Centrilobular (zone 3): primary injury site from venous back-pressure", "Whole liver affected grossly \u2014 'nutmeg liver' on cut surface", "Hepatic veins and IVC downstream pathology"],
    ...
    etiology: ["Right heart failure (commonest): IHD, cor pulmonale, cardiomyopathy", "Constrictive pericarditis: Kussmaul's sign, elevated JVP", "Tricuspid regurgitation or stenosis", "Budd\u2013Chiari syndrome: hepatic vein thrombosis \u2014 acute variant"],
    clinicalFeatures: ["Signs of right heart failure: raised JVP, peripheral oedema, hepatomegaly", "Pulsatile liver in tricuspid regurgitation", "Mild jaundice and elevated bilirubin", "Ascites in severe cases", "Hepatojugular reflux positive"],
    diagnosis: ["Echocardiography: identifies underlying cardiac pathology", "LFTs: mild elevation of AST/ALT/bilirubin; low albumin in chronic disease", "CT abdomen: patchy 'mosaic' hepatic enhancement", "Liver biopsy: centrilobular congestion, necrosis, fibrosis"],
    treatment: ["Treat underlying cardiac cause: diuretics, ACE inhibitors, beta-blockers", "Anticoagulation: for Budd\u2013Chiari or thrombotic causes", "Cardiac resynchronisation therapy (CRT) or cardiac transplant in refractory HF", "TIPS: for refractory ascites in cardiac cirrhosis"],
