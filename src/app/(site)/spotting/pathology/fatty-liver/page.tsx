...
const SLIDE_ID = "fatty-liver";

const IMAGES = ["/images/spotting/pathology/fatty-liver-sample.jpg", "/images/spotting/pathology/fatty-liver-mid.jpg", "/images/spotting/pathology/fatty-liver-high.jpg"] as const;
...
const DATA = {
    ...
    generalFeatures: ["Macro-vesicular steatosis: large single fat vacuole displacing nucleus to cell periphery", "Ballooned hepatocytes: swollen, pale, rarefied cytoplasm indicating cell injury", "Dilated central vein", "Micro-vesicular steatosis (severe cases): multiple small vacuoles, nucleus central", "Perivenular accentuation (alcoholic); pan-lobular (NAFLD)", "Mallory\u2013Denk bodies (eosinophilic intracytoplasmic inclusions) in NASH"],
    sites: ["Centrilobular (zone 3): alcoholic and NAFLD/NASH \u2014 most common pattern", "Periportal (zone 1): malnutrition, pregnancy, toxins", "Pan-lobular: severe systemic disease"],
    ...
    etiology: ["NAFLD/NASH: obesity, type 2 diabetes, metabolic syndrome \u2014 most common", "Alcohol excess: >21 units/week (males), >14 units/week (females)", "Drugs: amiodarone, methotrexate, corticosteroids, tamoxifen, valproate", "Acute fatty liver of pregnancy (AFLP): obstetric emergency", "Reye syndrome, Wilson's disease, starvation/TPN"],
    clinicalFeatures: ["Often asymptomatic \u2014 incidental finding on imaging", "Hepatomegaly: smooth, soft liver", "Elevated ALT/AST (AST:ALT <2 in NAFLD; >2 suggests alcohol)", "Fatigue and right upper quadrant discomfort", "NASH may progress: cirrhosis, portal hypertension, HCC"],
    diagnosis: ["Ultrasound: bright (echogenic) liver; sensitivity 60\u201394%", "Fibroscan (transient elastography): steatosis + fibrosis assessment", "Liver biopsy: gold standard \u2014 NAS score for NAFLD (steatosis + ballooning + inflammation)", "LFTs, fasting glucose, lipid profile, HbA1c"],
    treatment: ["Weight loss (>7\u201310%): most effective intervention for NAFLD", "Alcohol abstinence: essential for alcoholic fatty liver", "Vitamin E: for non-diabetic NASH (improves NAS score)", "GLP-1 agonists (semaglutide): emerging evidence for NASH regression", "Liver transplantation: for end-stage NASH cirrhosis"],
