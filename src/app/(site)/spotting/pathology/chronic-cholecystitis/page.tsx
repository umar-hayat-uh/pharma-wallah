...
const TITLE = "Chronic Cholecystitis";
const CAT = "Hepatobiliary";
const SLIDE_ID = "chronic-cholecystitis";

const IMAGES = ["/images/spotting/pathology/chronic-cholecystitis-sample.avif", "/images/spotting/pathology/chronic-cholecystitis-mid.jpg", "/images/spotting/pathology/chronic-cholecystitis-high.jpg"] as const;
const PO_URL = "https://www.pathologyoutlines.com/topic/gallbladderchroniccholecystitis.html";
const VIDEO_TITLE = "Chronic Cholecystitis — Pathology Lecture";
const VIDEO_URL = "https://youtu.be/7Ei37PY7lK4?si=AzcAC55PatRNj8OF";
...
const DATA = {
    definition: "Chronic cholecystitis is chronic, recurrent low-grade inflammation of the gallbladder, almost always associated with cholelithiasis (gallstones). Repeated bouts of obstruction and mild inflammation lead to fibrosis, wall thickening, and the formation of pathognomonic Rokitansky\u2013Aschoff sinuses.",
    generalFeatures: ["Rokitansky\u2013Aschoff sinuses (RAS): epithelium-lined crypts herniating through the muscularis", "Mononuclear inflammatory infiltrate (lymphocytes, plasma cells) in lamina propria", "Sub-epithelial and sub-serosal fibrosis causing gallbladder shrinkage", "Hypertrophy of the muscularis propria", "Cholesterol clefts or calcium deposits may be present", "Mucosal folds may be flattened or atrophied"],
    sites: ["Gallbladder \u2014 body and fundus most commonly affected", "Associated with gallstones in >90% of cases", "Porcelain gallbladder: dystrophic calcification of the wall (rare)"],
    pathophysiology: "Repeated mechanical irritation and intermittent obstruction by gallstones activate a chronic inflammatory cascade. Persistent inflammation leads to mucosal metaplasia, fibrosis, and muscle hypertrophy. Increased intraluminal pressure forces epithelium into the wall, creating RAS. Shrinkage and scarring impair gallbladder contractility.",
    etiology: ["Cholelithiasis (gallstones) \u2014 present in >90%", "Acalculous chronic cholecystitis \u2014 rare, secondary to ischaemia or infection", "Risk factors: female, fat, forty, fertile (5 Fs)", "Salmonella typhi chronic carrier state can cause cholecystitis"],
    clinicalFeatures: ["Recurrent right upper quadrant or epigastric pain (biliary colic)", "Nausea and fat intolerance", "Pain precipitated by fatty meals (cholecystokinin release)", "Murphy's sign positive on deep palpation", "Jaundice if common bile duct obstructed (Mirizzi syndrome)"],
    diagnosis: ["Ultrasound: gallstones, thickened gallbladder wall (>3 mm), pericholecystic fluid", "HIDA scan: reduced gallbladder ejection fraction (<35%)", "CT/MRCP: complications and anatomy", "Histopathology post-cholecystectomy: confirms chronic inflammation and RAS"],
    treatment: ["Elective laparoscopic cholecystectomy \u2014 definitive treatment", "Low-fat diet for symptomatic relief pre-operatively", "ERCP with stone extraction if choledocholithiasis present", "Ursodeoxycholic acid (UDCA) for dissolution in non-surgical candidates"],
    prev: { id: "acute-appendicitis", title: "Acute Appendicitis" },
    next: { id: "gastritis", title: "Gastritis" },
};
...
// ── main page ─────────────────────────────────────────────────────────────────
export default function PathologyChronicCholecystitisPage() {
                    ...
                    <article className="bg-white rounded-2xl shadow-2xl p-5 sm:p-8 md:p-12">
                        ...
                        {VIDEO_URL ? (
                            <div className="my-8">
                                ...
                                <div
                                    className="relative rounded-2xl overflow-hidden border border-gray-200 bg-black"
                                    style={{ paddingTop: "56.25%" }}
                                >
                                    <iframe
                                        src="https://www.youtube.com/embed/7Ei37PY7lK4"
                                        title={VIDEO_TITLE}
