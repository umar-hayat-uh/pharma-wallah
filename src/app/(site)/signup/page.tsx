                ...
                <div className="mx-auto w-full max-w-sm lg:max-w-md">
                    ...
                    <div className="mb-10">
                        ...
                        <p className="text-slate-500 text-base leading-relaxed">
                            Join Pakistan&apos;s #1 pharmacy e‑learning platform and start your
                            journey today.
                        </p>
                    </div>
                ...
                <div className="relative z-10 w-full max-w-lg px-8 flex flex-col items-center">
                    ...
                    <div className="text-center">
                        ...
                        <p className="text-slate-600 text-sm leading-relaxed">
                            Connect with expert educators, track your progress, and excel in
                            your pharmacy studies with our comprehensive toolkit.
                        </p>
                    </div>
                </div>
            </div>
