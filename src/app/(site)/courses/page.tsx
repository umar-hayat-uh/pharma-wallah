  ...
  return (
    <section className="min-h-screen bg-white relative overflow-x-hidden">
      ...
      <div className="relative bg-gradient-to-r from-blue-600 to-green-400 overflow-hidden">
        ...
        <div className="absolute right-8 sm:right-20 bottom-4 opacity-15 pointer-events-none hidden sm:block">
          <Dna size={60} className="text-white" />
        </div>
        <div className="absolute right-28 sm:right-44 top-6 opacity-15 pointer-events-none hidden sm:block">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 md:py-20 text-center">
          ...
          <motion.h1
            ...
            className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold text-white mb-4 leading-tight tracking-tight">
            Study Material
          ...
          <motion.p
            ...
            className="text-blue-100 text-sm sm:text-base lg:text-lg max-w-2xl mx-auto mb-8 leading-relaxed px-2">
          ...
          <motion.div
            ...
            <div className="relative flex items-center bg-white rounded-2xl border border-white/30 shadow-sm overflow-hidden">
              ...
              <input type="text" placeholder="Search subjects..."
                ...
                className="w-full pl-11 pr-12 py-3.5 sm:py-4 text-sm text-gray-800 placeholder:text-gray-400 focus:outline-none bg-transparent" />
              <AnimatePresence>
                {searchQuery && (
                  <motion.button
        ...
        {filteredSemesters.map(({ semester, subjects }: any) => (
          <motion.div key={semester}
            ...
            <div className="flex items-center gap-3 mb-5 sm:mb-8 flex-wrap">
              ...
              <h2 className="text-xl sm:text-2xl font-extrabold text-gray-900 tracking-tight">{semester}</h2>
                  ...
                  <motion.div key={subj.name} variants={fadeUp}>
                    <Link href={href} className="group block h-full">
                      <motion.div
                        ...
                        <div className="relative z-10 mt-3 sm:mt-4 flex items-center justify-between pt-3 border-t border-gray-100">
