...
const allTools = [
    ...
    // Pharmacology
    { name: "Animal Weight-Based Dose Calculator", link: "/calculation-tools/animal-dose" },
    { name: "Serial Dose Calculator", link: "/calculation-tools/serial-diluation" },
...
const categories = [
    ...
    { id: "pharmacology", label: "Pharmacology", desc: "Drug-receptor interactions, dose-response and safety margins", toolNames: ["Animal Weight-Based Dose Calculator", "Serial Dose Calculator", "Drug–Receptor Binding Affinity Tool", "Therapeutic Index Calculator", "Dose–Response Curve Generator", "ED50 / TD50 / LD50 Calculator"] },
