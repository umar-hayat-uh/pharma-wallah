...
import { Calculator, Scale, BarChart, AlertCircle, CheckCircle, XCircle, TrendingUp, Target, Percent, GitCompare, Activity } from 'lucide-react';
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-between">
                        <div className="flex items-center mb-4 md:mb-0">
                            <div className="bg-white/20 p-3 rounded-xl mr-4">
                                <GitCompare className="w-8 h-8 md:w-10 md:h-10 text-white" />
                            </div>
                            <div>
                                <h1 className="text-2xl md:text-3xl font-bold text-white">Content Uniformity Calculator</h1>
                                <p className="text-blue-100 mt-2">USP &lt;905&gt; – Evaluate dosage unit consistency</p>
                            </div>
                        </div>
                        <div className="flex gap-3">
                            <button
                                onClick={() => { setUnits(exampleData.passing); setLabelClaim('100'); }}
                                className="px-4 py-2 bg-green-100 text-green-700 rounded-lg hover:bg-green-200 transition-colors text-sm"
                            >
                                Passing
                            </button>
                            <button
                                onClick={() => { setUnits(exampleData.borderline); setLabelClaim('100'); }}
                                className="px-4 py-2 bg-yellow-100 text-yellow-700 rounded-lg hover:bg-yellow-200 transition-colors text-sm"
                            >
                                Borderline
                            </button>
                            <button
                                onClick={() => { setUnits(exampleData.failing); setLabelClaim('100'); }}
                    ...
                    <div className="lg:col-span-2">
                        <div className="bg-white rounded-2xl shadow-lg p-6 md:p-8 mb-8">
                            ...
                            <div className="mb-8 bg-gradient-to-r from-blue-50 to-green-50 rounded-xl p-6">
                                <label className="block text-lg font-semibold text-blue-800 mb-3">Label Claim (mg or %)</label>
                                <input
                                    type="number"
                                    step="0.1"
                                    value={labelClaim}
                            ...
                            <div className="mb-8">
                                <div className="flex justify-between items-center mb-4">
                                    <h3 className="text-lg font-semibold text-gray-800">Individual Unit Contents</h3>
                                    <button
                            ...
                            <div className="flex flex-col sm:flex-row gap-4">
                                <button
                                    ...
                                    className="flex-1 bg-gradient-to-r from-blue-600 to-green-400 hover:from-blue-700 hover:to-green-500 text-white font-semibold py-4 rounded-lg transition-all duration-300 text-lg shadow-lg hover:shadow-xl"
                                >
                            ...
                            <div className="bg-white rounded-2xl shadow-lg p-6 md:p-8">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                                    ...
                                    <div className="bg-gradient-to-br from-green-50 to-emerald-100 rounded-xl p-6">
                                        <div className="text-sm font-semibold text-green-700 mb-2">RSD</div>
                                        ...
                                        <div className="text-sm text-green-600 mt-2">Target: ≤6%</div>
                                    </div>
                                ...
                                {/* Final Result */}
                                <div className={`rounded-xl p-6 mb-6 ${results.finalResult === 'PASS' ? 'bg-gradient-to-r from-green-50 to-emerald-100 border-2 border-green-200' : results.finalResult === 'TEST STAGE 2' ? 'bg-gradient-to-r from-yellow-50 to-amber-100 border-2 border-yellow-200' : 'bg-gradient-to-r from-red-50 to-rose-100 border-2 border-red-200'}`}>
                                        ...
                                        <div>
                                            ...
                                            <p className="text-gray-600">
                                                {results.finalResult === 'PASS' 
                                                    ...
                                                    ? 'Proceed to Stage 2: test 20 additional units.'
                                ...
                                <div className="bg-gray-50 rounded-xl p-6">
                                    <h3 className="text-lg font-semibold text-gray-800 mb-4">Distribution (% of Label Claim)</h3>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-white rounded-2xl shadow-lg p-6">
                            ...
                            <div className="bg-gray-50 p-4 rounded-lg">
                                ...
                                <div className="text-sm text-gray-600 space-y-2">
                                    ...
                                    <p>• M = Reference value (98.5–101.5% of label claim)</p>
                                    <p>• X̄ = Sample mean</p>
                                    <p>• k = 2.4 (for n=10)</p>
                        ...
                        <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl shadow-lg p-6">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="bg-white rounded-lg p-4">
                                    ...
                                    <ul className="text-sm text-gray-600 space-y-1">
                                        <li>• AV ≤ 25.0</li>
                                        <li>• At least 24 units 85.0–115.0%</li>
                        ...
                        <div className="bg-white rounded-2xl shadow-lg p-6">
                            ...
                            <div className="space-y-3 text-sm text-gray-600">
                                ...
                                <div className="flex items-start">
                                    <CheckCircle className="w-4 h-4 text-green-500 mr-2 mt-0.5 flex-shrink-0" />
                                    <span>Perform on finished product and during stability.</span>
                                </div>
                                <div className="flex items-start">
