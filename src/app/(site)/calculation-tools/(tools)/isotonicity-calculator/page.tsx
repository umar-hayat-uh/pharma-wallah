...
import { Calculator, Droplets, Thermometer, Plus, Trash2, AlertCircle, FlaskConical, Eye, Syringe, Brain } from 'lucide-react';
...
export default function IsotonicityCalculator() {
  ...
  const calculateIsotonicity = () => {
    ...
    ingredients.forEach(ingredient => {
      ...
      if (ingredient.concentrationUnit === 'mg/mL') {
        ...
        // Approximate conversion for calculation
        concentrationPercent = concentration * 0.001; // Simplified
      }
  ...
  return (
    <section className="min-h-screen bg-gradient-to-br from-blue-50 to-cyan-50 p-4 pt-20">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
          <div className="flex flex-col md:flex-row items-center justify-between mb-6">
            <div className="flex items-center mb-4 md:mb-0">
              ...
              <div>
                <h1 className="text-3xl font-bold text-gray-800">Isotonicity Calculator</h1>
                <p className="text-gray-600">Calculate sodium chloride equivalents (E-values) for ophthalmic and parenteral formulations</p>
              </div>
            </div>
            <button
              onClick={() => {
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3">
                  {commonIngredients.map((ing, index) => (
                    ...
                    >
                      ...
                      <div className="text-sm text-cyan-600">E-value: {ing.eValue}</div>
                    </button>
                  ))}
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <button
                  ...
                  className="flex-1 bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-700 hover:to-blue-700 text-white font-semibold py-4 rounded-lg transition-all duration-300 text-lg shadow-lg hover:shadow-xl"
                >
              ...
              <div className="bg-white rounded-2xl shadow-xl p-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                  <div className={`rounded-xl p-6 ${result.tonicity === 'isotonic' ? 'bg-gradient-to-br from-green-50 to-emerald-100' : result.tonicity === 'hypotonic' ? 'bg-gradient-to-br from-blue-50 to-cyan-100' : 'bg-gradient-to-br from-red-50 to-rose-100'}`}>
                    ...
                    <div className={`text-sm font-bold ${result.tonicity === 'isotonic' ? 'text-green-600' : result.tonicity === 'hypotonic' ? 'text-blue-600' : 'text-red-600'}`}>
                      {result.tonicity.toUpperCase()}
                    </div>
                    <div className="text-sm text-gray-600 mt-2">
                      {result.tonicity === 'isotonic' 
                        ? 'Ideal for ophthalmic use' 
                        : result.tonicity === 'hypotonic'
                  ...
                  <div className="bg-gradient-to-br from-cyan-50 to-blue-100 rounded-xl p-6">
                    ...
                    <div className="text-basefont-bold text-cyan-600">
                      {result.naclToAdd.toFixed(3)}%
                    </div>
                    <div className="text-sm text-cyan-600 mt-2">per 100 mL solution</div>
                  </div>
                  ...
                  <div className="bg-gradient-to-br from-purple-50 to-violet-100 rounded-xl p-6">
                    ...
                    <div className="text-sm text-purple-600 mt-2">ΔTf (Isotonic: -0.52°C)</div>
                  </div>
                  ...
                  <div className="bg-gradient-to-br from-orange-50 to-amber-100 rounded-xl p-6">
                    ...
                    <div className="text-sm text-orange-600 mt-2">Blood: 285-295 mOsm/kg</div>
                  </div>
                </div>
                ...
                <div className="mb-8">
                  ...
                  <div className="h-12 bg-gradient-to-r from-blue-400 via-green-400 to-red-400 rounded-full relative">
                    <div className="absolute top-0 bottom-0 w-1 bg-black" 
                      style={{ left: `${Math.min((result.naclEquivalent / 1.8) * 100, 100)}%` }}>
                ...
                <div className="bg-gradient-to-r from-cyan-50 to-blue-50 rounded-xl p-6">
                  ...
                  <div className="space-y-3 text-sm text-gray-700">
                    <p>1. To make this formulation isotonic, add <strong>{result.naclToAdd.toFixed(3)} g</strong> of sodium chloride per 100 mL of final solution.</p>
                    <p>2. Alternatively, you can use other tonicity adjusters:</p>
                    <ul className="ml-4 space-y-1">
                      <li>• Dextrose: {(result.naclToAdd / 0.18).toFixed(2)}%</li>
                      <li>• Glycerin: {(result.naclToAdd / 0.34).toFixed(2)}%</li>
                      <li>• Boric acid: {(result.naclToAdd / 0.50).toFixed(2)}%</li>
                    </ul>
                    <p>3. For ophthalmic solutions, aim for exact isotonicity (0.9% NaCl equivalent).</p>
                    <p>4. For parenteral solutions, 0.5-1.5% NaCl equivalent is generally acceptable.</p>
                  </div>
                </div>
              </div>
            )}
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white rounded-2xl shadow-xl p-6">
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                ...
                <div className="text-sm text-gray-600 space-y-2">
                  ...
                  <p>• C = Concentration of ingredient (% w/v)</p>
                  <p>• E = NaCl equivalent value</p>
                  <p>• 0.9% = Isotonic NaCl concentration</p>
                  <p>• Σ = Sum of all ingredients</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-cyan-50 to-blue-50 rounded-2xl shadow-xl p-6">
              <h3 className="text-lg font-bold text-gray-800 mb-4 flex items-center">
                ...
                Importance for Formulations
              </h3>
              <div className="space-y-3 text-sm text-gray-600">
                <div className="flex items-start">
                  <div className="w-2 h-2 bg-cyan-500 rounded-full mt-1 mr-2"></div>
                  <span>Prevents ocular discomfort and tissue damage</span>
                </div>
                <div className="flex items-start">
                  <div className="w-2 h-2 bg-cyan-500 rounded-full mt-1 mr-2"></div>
                  <span>Essential for IV solutions to prevent hemolysis</span>
                </div>
                <div className="flex items-start">
                  <div className="w-2 h-2 bg-cyan-500 rounded-full mt-1 mr-2"></div>
                  <span>Affects drug absorption and bioavailability</span>
                </div>
                <div className="flex items-start">
                  <div className="w-2 h-2 bg-cyan-500 rounded-full mt-1 mr-2"></div>
                  <span>Required by pharmacopoeias for ophthalmic products</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-6">
              ...
              <div className="space-y-3 text-sm">
                <div className="flex justify-between items-center p-2 bg-gray-50 rounded-lg">
                  <span className="font-medium">Sodium Chloride</span>
                  <span className="font-bold text-cyan-600">1.00</span>
                </div>
                <div className="flex justify-between items-center p-2 bg-gray-50 rounded-lg">
                  <span className="font-medium">Dextrose</span>
                  <span className="font-bold text-cyan-600">0.18</span>
                </div>
                <div className="flex justify-between items-center p-2 bg-gray-50 rounded-lg">
                  <span className="font-medium">Boric Acid</span>
                  <span className="font-bold text-cyan-600">0.50</span>
                </div>
                <div className="flex justify-between items-center p-2 bg-gray-50 rounded-lg">
                  <span className="font-medium">Glycerin</span>
                  <span className="font-bold text-cyan-600">0.34</span>
                </div>
                <div className="flex justify-between items-center p-2 bg-gray-50 rounded-lg">
                  <span className="font-medium">Mannitol</span>
                  <span className="font-bold text-cyan-600">0.18</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl shadow-xl p-6">
              ...
              <div className="space-y-3 text-sm text-gray-600">
                <div className="p-3 bg-white rounded-lg">
                  <h4 className="font-semibold text-purple-700 mb-1">Ophthalmic Solutions</h4>
                  <p>Must be isotonic (0.6-1.1% NaCl equivalent) to prevent corneal damage</p>
                </div>
                <div className="p-3 bg-white rounded-lg">
                  <h4 className="font-semibold text-purple-700 mb-1">IV Solutions</h4>
                  <p>0.45-0.9% NaCl equivalent acceptable for most drugs</p>
                </div>
                <div className="p-3 bg-white rounded-lg">
                  <h4 className="font-semibold text-purple-700 mb-1">IM Injections</h4>
                  <p>Small volumes can be slightly hypertonic</p>
                </div>
                <div className="p-3 bg-white rounded-lg">
                  <h4 className="font-semibold text-purple-700 mb-1">Neonatal/Pediatric</h4>
                  <p>Strict isotonicity required</p>
                </div>
              </div>
            </div>
          </div>
