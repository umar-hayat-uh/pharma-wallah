                  ...
                  <div className="grid grid-cols-3 gap-1.5 text-xs font-bold">
                    {[
                      ...
                      <button
                        ...
                        className={`p-2.5 rounded-xl border transition text-center flex flex-col items-center justify-center ${
                          ascites === item.id
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      ...
                      className={`px-2 py-0.5 rounded text-[10px] font-bold transition ${
                        enableMeld ? "bg-blue-600 text-white" : "bg-gray-200 text-gray-700"
                      }`}
                    >
