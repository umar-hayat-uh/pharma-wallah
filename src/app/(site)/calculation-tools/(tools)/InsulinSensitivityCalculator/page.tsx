                            ...
                            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-gray-100 pb-3">
                                ...
                                <div className="inline-flex rounded-xl bg-gray-100 p-1 text-xs font-bold">
                                    <button
                                        ...
                                        className={`px-3 py-1 rounded-lg transition ${glucoseUnit === "mg/dL"
                                    ...
                                    <button
                                        ...
                                        className={`px-3 py-1 rounded-lg transition ${glucoseUnit === "mmol/L"
                                                ? "bg-white text-blue-700 shadow-xs"
                                                : "text-gray-600 hover:text-gray-900"
                                            }`}
                                    >
                                    ...
                                    <div className="grid grid-cols-5 gap-1 text-xs font-bold">
                                        {(["1500", "1700", "1800", "2000", "2200"] as RuleISF[]).map((r) => (
                                            <button
                                                ...
                                                className={`py-1.5 rounded-lg border transition text-center ${ruleISF === r
                                    ...
                                    <div className="grid grid-cols-4 gap-1 text-xs font-bold">
                                        {(["300", "400", "450", "500"] as RuleICR[]).map((r) => (
                                            <button
                                                ...
                                                className={`py-1.5 rounded-lg border transition text-center ${ruleICR === r
