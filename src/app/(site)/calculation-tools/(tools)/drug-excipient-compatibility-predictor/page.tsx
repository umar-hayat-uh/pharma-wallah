...
import { Calculator, AlertTriangle, Shield, FlaskConical, Zap, Thermometer, Droplet, Beaker, TestTube, Atom, Activity } from 'lucide-react';
...
export default function DrugExcipientCompatibilityPredictor() {
    ...
    const calculateCompatibility = () => {
        ...
        if (compatibilityFactors.some(f => f.id === 'f2' && f.selected)) {
            recommendations.push('Use moisture barrier packaging (blister, desiccant).');
        }
        if (compatibilityFactors.some(f => f.id === 'f3' && f.selected)) {
            recommendations.push('Use light-resistant packaging (amber glass, opaque containers).');
        }
    ...
    return (
        <section className="min-h-screen bg-gradient-to-br from-amber-50 to-orange-50 p-4 md:p-6 pt-20">
                ...
                <div className="bg-gradient-to-r from-blue-600 to-green-400 rounded-2xl shadow-xl p-6 md:p-8 mb-6 md:mb-8">
                    <div className="flex flex-col md:flex-row items-center justify-between">
                        <div className="flex items-center mb-4 md:mb-0">
                            ...
                            <div>
                                <h1 className="text-2xl md:text-3xl font-bold text-white">Drug-Excipient Compatibility Predictor</h1>
                                <p className="text-amber-100 mt-2">Risk assessment for chemical interactions</p>
                            </div>
                        </div>
                        <button
                            onClick={loadExample}
                    ...
                    <div className="lg:col-span-2">
                        <div className="bg-white rounded-2xl shadow-lg p-6 md:p-8 mb-8">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4">
                                <button
                                    ...
                                    className="flex-1 bg-gradient-to-r from-orange-600 to-amber-400 hover:from-orange-700 hover:to-amber-500 text-white font-semibold py-4 rounded-lg transition-all duration-300 text-lg shadow-lg hover:shadow-xl"
                                >
                                    Calculate Risk
                                </button>
                                <button
                        ...
                        {results && (
                            <div className="bg-white rounded-2xl shadow-lg p-6 md:p-8">
                                ...
                                {/* Risk Summary */}
                                <div className={`rounded-xl p-6 mb-8 ${results.compatibility === 'compatible'
                                        ...
                                        <div>
                                            ...
                                            <p className="text-gray-600">
                                                {results.compatibility === 'compatible'
                                                    ? 'Low risk – Proceed with formulation.'
                                                    : results.compatibility === 'caution'
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                                    <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl p-6">
                                        ...
                                        <div className="text-sm text-gray-600 mt-2">Higher score = greater risk</div>
                                    </div>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-white rounded-2xl shadow-lg p-6">
                            ...
                            <div className="space-y-2">
                                <div className="p-2 bg-red-50 rounded-lg text-sm">Amino drugs + Lactose</div>
                                <div className="p-2 bg-red-50 rounded-lg text-sm">Aspirin + Alkaline excipients</div>
                                <div className="p-2 bg-yellow-50 rounded-lg text-sm">Antioxidants + Oxidizing agents</div>
                            </div>
                        </div>
                        ...
                        <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl shadow-lg p-6">
                            ...
                            <div className="space-y-3 text-sm">
                                <div className="p-3 bg-white rounded-lg">
                                    <span className="font-semibold">For amine drugs:</span> Use mannitol instead of lactose.
                                </div>
                                <div className="p-3 bg-white rounded-lg">
                                    <span className="font-semibold">For ester drugs:</span> Maintain acidic pH, use desiccants.
                                </div>
                                <div className="p-3 bg-white rounded-lg">
                                    <span className="font-semibold">For oxidation-prone:</span> Add antioxidants, nitrogen blanket.
                                </div>
                            </div>
                        </div>
                    </div>
