    ...
    if (calculationMode === "mass-volume") {
      ...
      if (
        ...
        switch (toUnit) {
          case "ppm":
            result =
              solutionType === "water" ? resultMgL : resultMgL / densityVal;
            break;
          case "ppb":
      ...
      if (!isNaN(concVal) && concVal >= 0) {
        const fromFactor =
          concentrationUnits.find((u) => u.value === fromUnit)?.factor || 1;
        const toFactor =
          concentrationUnits.find((u) => u.value === toUnit)?.factor || 1;
      ...
      <div className="max-w-6xl mx-auto">
            ...
            <div className="flex items-center mb-4 md:mb-0">
              ...
              <div>
                ...
                <p className="text-green-100 mt-2">
                  Convert between concentration units and calculate dilutions
                </p>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6 md:p-8">
              ...
              {solutionType === "other" && (
                <div className="mt-3">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2 border-2 border-green-200 rounded-lg focus:border-green-500 focus:ring-2 focus:ring-green-200 outline-none"
                ...
                <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <input
                          ...
                          className="w-full px-4 py-3 border-2 border-green-200 rounded-lg focus:border-green-500 focus:ring-2 focus:ring-green-200 outline-none"
                          placeholder={
                            soluteType === "solid" ? "e.g., 1" : "e.g., 1"
                          }
                        />
                  ...
                  <div>
                    ...
                    <select
                      value={toUnit}
                      onChange={(e) =>
                        setToUnit(e.target.value as ConcentrationUnit)
                      }
                      className="w-full px-4 py-3 border-2 border-green-200 rounded-lg bg-white focus:border-green-500 focus:ring-2 focus:ring-green-200 outline-none"
                    >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <select
                      value={fromUnit}
                      onChange={(e) =>
                        setFromUnit(e.target.value as ConcentrationUnit)
                      }
                      className="w-full px-4 py-3 border-2 border-green-200 rounded-lg bg-white focus:border-green-500 focus:ring-2 focus:ring-green-200 outline-none"
                    >
                      {concentrationUnits.map((unit) => (
            ...
            {/* Formula Toggle */}
            <div className="bg-gradient-to-r from-green-50 to-green-50 rounded-xl p-4 border border-green-200 mt-6">
              <button
              ...
              >
                ...
                <Zap
                  className={`w-5 h-5 text-green-600 transform transition-transform ${showFormula ? "rotate-180" : ""}`}
                />
              </button>
              ...
              {showFormula && (
                <div className="mt-4 p-4 bg-white rounded-lg border border-gray-200">
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    <p>
                      <span className="font-semibold">1 ppm</span> = 1000 ppb =
                      1,000,000 ppt
                    </p>
                    <p>
                      <span className="font-semibold">1 mg/L</span> = 1000 μg/L
                      = 1,000,000 ng/L
                    </p>
                    <p>
                      <span className="font-semibold">Molarity to ppm:</span>{" "}
                      ppm = M × MW × 1000
                    </p>
                    <p>
                      <span className="font-semibold">For other solvents:</span>{" "}
                      ppm = (mg/L) ÷ density
                    </p>
                    <p className="text-xs text-gray-600 mt-2">
                      Note: These conversions assume dilute aqueous solutions at
                      room temperature
                    </p>
                  </div>
                </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-6">
              <button
                ...
                className="flex-1 bg-gradient-to-r from-blue-600 to-green-400 hover:from-green-700 hover:to-green-500 text-white font-semibold py-4 px-6 rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl"
              >
                {calculationMode === "mass-volume"
                ...
                <div className="text-center">
                  ...
                  {convertedValue !== null ? (
                    <>
                      ...
                      <div className="text-2xl font-semibold">{toUnit}</div>
                    </>
                  ) : (
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b text-gray-700 font-semibold">
                      ...
                      <th className="py-2 text-left">Regulation</th>
                  ...
                  <tbody>
                    {[
                      {
                        range: "Drinking Water (Pb)",
                        value: "0.015",
                        unit: "ppm",
                        regulation: "EPA limit",
                      },
                      {
                        range: "Sea Water (Salt)",
                        value: "35000",
                        unit: "ppm",
                        regulation: "Average",
                      },
                      {
                        range: "Blood Alcohol (0.08%)",
                        value: "800",
                        unit: "ppm",
                        regulation: "Legal limit",
                      },
                      {
                        range: "Vitamin C in Orange",
                        value: "500",
                        unit: "ppm",
                        regulation: "Typical",
                      },
                      {
                        ...
                        value: "420",
                        unit: "ppm",
                        regulation: "Current average",
                      },
                      {
                        range: "Gold in Seawater",
                        value: "0.000004",
                        unit: "ppm",
                        regulation: "Trace",
                      },
