...
export const pharmaCo: Tool[] = [
  //  Pharmaceutical Chemistry
  {
    ...
    tools: [
      ...
      {
        name: "Solubility Calculator",
        link: "/calculation-tools/solubility-calculator",
      },
      {
        name: "Heat Formation Calculator",
  ...
  // "Clinal And Pharmaceutical Pharmacy"
  {
    ...
    tools: [
      ...
      },
      {
        ...
        link: "/calculation-tools/iv-drip-rate-calculator",
      },
      {
        name: "Anti Coagulation Risk Calculator",
